...
public class MagicSquareAOstar {
    ...
    private static State aoStar(int[][] initialSquare, int maxIterations) {
    ...
    public static void main(String[] args) {
        ...
        int maxIterations = 1000; // Maximum iterations (you can adjust this value)

        State result = aoStar(initialSquare, maxIterations);

        if (result == null) {
            System.out.println("No magic square found within the specified iterations.");
        }
    }
}
